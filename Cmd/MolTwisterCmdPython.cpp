...
std::string CCmdPython::getHelpString() const
{
    ...
    text+= "\r\n";
    text+= "\t\tmt_create_xyz_file(filePath:string) : no result\r\n";
    text+= "\t\tCreate an empty XYZ file.\r\n";
    text+= "\r\n";
    text+= "\t\tmt_append_to_xyz_file(filePath:string, boxSizeX:float, boxSizeY:float, boxSizeZ:float, convertToAU:bool, atomCoordinates:list) : no result\r\n";
    text+= "\t\tAppend list of [atomTypeString, x, y, z]-lists to XYZ file.\r\n";
    text+= "\r\n";
    text+= "\t\tmt_create_dcd_file(filePath:string, numTimeSteps:int, stride:int, timeStep:float, numAtoms:int) : no result\r\n";
    text+= "\t\tCreate a DCD file with given header information.\r\n";
    text+= "\r\n";
    text+= "\t\tmt_append_to_dcd_file(filePath:string, boxSizeX:float, boxSizeY:float, boxSizeZ:float, atomCoordinates:list) : no result\r\n";
